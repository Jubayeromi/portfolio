...
export const FloatingNav = ({
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        <div className="flex items-center justify-center gap-2 rounded-full border   px-8 bg-black-100 py-4 border-white/[0.2] shadow-lg shadow-black/10 backdrop-blur-md ">
          {/* Nav items container */}
